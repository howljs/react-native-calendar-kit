...
import { dateTimeToISOString, parseDateTime } from './dateUtils';
import { useNotifyDateChanged } from './VisibleDateProvider';

export const useSyncedList = ({ id }: { id: ScrollType }) => {
  const {
    scrollType,
    gridListRef,
    dayBarListRef,
