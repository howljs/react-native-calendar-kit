...
const VisibleDateValueContext = React.createContext<number | undefined>(undefined);

const VisibleDateActionsContext = React.createContext<((date: number) => void) | undefined>(
  undefined
);
