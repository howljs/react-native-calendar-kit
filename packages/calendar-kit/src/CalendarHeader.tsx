...
const CalendarHeader: React.FC<CalendarHeaderProps> = ({
  ...
  const eventHeight = useDerivedValue(
    ...
    [eventInitialMinutes, minuteHeight, eventMinMinutes, eventMaxMinutes]
  );
  ...
  }, [maxEventRows, collapsedItems, isExpanded]);
  ...
  const allDayEventsHeight = useDerivedValue(() => {
    ...
    return nextHeight;
  }, [numberOfDays, headerBottomHeight, visibleRows, eventHeight]);
