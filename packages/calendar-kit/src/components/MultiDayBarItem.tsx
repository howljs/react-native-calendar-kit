...
const MultiDayBarItem: React.FC<MultiDayBarItemProps> = ({
  ...
  }, [allDayEventsHeight, dayBarHeight]);
  ...
  return (
    <Animated.View style={containerHeight}>
      ...
      <Animated.View style={[dayBarStyles.allDayEventsContainer, eventsContainerStyle]}>
        <Touchable
    ...
    <Animated.View style={eventContainerStyle}>
      <TouchableOpacity
        ...
        {renderEvent ? (
          ...
          <Text style={[styles.eventTitle, rest.titleStyle, { color: rest.titleColor }]}>
            {rest.title}
          </Text>
        )}
      </TouchableOpacity>
